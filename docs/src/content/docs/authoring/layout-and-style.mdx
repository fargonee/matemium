...
```python
builder.add_heading("The central idea")
builder.add_body("A readable explanatory paragraph.")
builder.add_observation("Notice what changes and what remains fixed.")
```
