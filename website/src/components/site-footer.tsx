...
import { SocialLinkStrip } from "@/components/social-links";
...
const GROUPS = [
  ...
  {
    title: "Project",
    links: [["Documentation", "https://docs.matemium.fargonee.space"], ["Source & license", "/source"], ["GitHub", "https://github.com/fargonee/matemium"], ["Contributing", "https://github.com/fargonee/matemium/blob/main/CONTRIBUTING.md"], ["Sign in", "/login"]],
  },
  {
    title: "Legal",
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="footer-social-row">
          <div>
            ...
            <p>Films, release notes, technical stories, and conversation.</p>
          </div>
          <SocialLinkStrip />
        </div>
      </div>
